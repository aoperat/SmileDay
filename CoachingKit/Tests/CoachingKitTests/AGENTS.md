...
| `LiveSmileSessionRecorderTests` | Bucket majority (including the exactly-half and tie boundaries), gaps filled with unknown, ratio excluding unknown, and empty-session divide-by-zero guards |
